...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px;">
        @if($daysRemaining < 0)
            ...
            <p style="color: #dc2626; font-weight: bold;">The book you borrowed is now <strong>{{ abs($daysRemaining) }} day(s) overdue</strong>.</p>
        @else
            <h2 style="color: #f59e0b;">📅 Book Return Due Soon</h2>
            <p>Hello {{ $bookRequest->borrower->name }},</p>
            <p>This is a friendly reminder that the book you borrowed is due in <strong>{{ $daysRemaining }} day(s)</strong>.</p>
        @endif
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; text-align: center;">
            <a href="{{ route('requests.index') }}" style="display: inline-block; background: #667eea; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold;">View My Requests</a>
        </div>
    </div>
