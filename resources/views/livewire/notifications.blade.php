    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="space-y-4">
            @forelse($this->notifications as $notification)
                <div
                    class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 overflow-hidden transform hover:-translate-y-1 transition-all duration-300 {{ !$notification->read ? 'border-indigo-300 bg-indigo-50/50' : '' }}">
                    <div class="p-6">
            ...
            @empty
                <div class="text-center py-20">
                    ...
                    <p class="text-slate-500 text-lg">You'll see notifications here when you receive book requests or
                        updates.</p>
                </div>
            @endforelse
        </div>
